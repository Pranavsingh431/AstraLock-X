  ...
  return (
    <header className="flex h-12 shrink-0 items-center gap-3 border-b bg-card/30 px-4">
      <span className="flex shrink-0 items-center gap-2">
        <Crosshair aria-hidden className="size-4 text-cyan-400" />
      ...
      <span className="ml-auto flex shrink-0 items-center gap-2">
        {recording && (
          <Badge
            variant="outline"
            className="gap-1.5 border-red-500/60 bg-red-500/10 text-[10px] font-semibold tracking-wider text-red-300 uppercase"
          >
